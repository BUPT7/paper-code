function [ pS,pR,pO,pQ ] = WaterFilling_alg_4( H11,H22,H33,H44,H12,H13,H14,H21,H23,H24,H31,H32,H34,H41,H42,H43,beta1,beta2,beta3,beta4,sigma_n,iter_num,P1_max,P2_max,P3_max,P4_max,e,aL )
...
for iter = 1 : iter_num
   ...
   g4( :,iter ) = ( 1 - beta4 ) * trace( H44 * H44') * pQ( :,iter ) - e;
...
%% Update p1£¬p2 with lamda1,lamda2 fixed
  ...
  gammaQ( :,iter ) = lamda4 * ( 1 - beta4 ) * trace( H44 * H44');
