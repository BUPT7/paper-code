...
load('./results/Chen_GAME_TTI=100_N=2_p=30_sigma=1_p1=1_p2=0.5.mat');
figure(2);
iter = 30;
number = 2;
init_point = 1;
...
load('./results/Chen_GAME_TTI=100_N=2_p=20_sigma=1_p1=1_p2=0.5.mat');
figure(2);
iter = 30;
number = 2;
init_point = 1;
...
load('./results/Chen_GAME_TTI=100_N=2_p=30_sigma=0.5_p1=1_p2=0.5.mat');
figure(2);
iter = 30;
number = 2;
init_point = 1;
...
load('./results/Chen_GAME_TTI=100_N=2_p=20_sigma=0.5_p1=1_p2=0.5.mat');
figure(2);
iter = 30;
number = 2;
init_point = 1;
...
xlabel('dL');                                                 %Label for x-axis
ylabel('sum rate'); 
axis([0.1 2.5 0.3 2.5]) %Label for y-axis
grid on;
legend(scheme_name(1,1:number),0);
title('sum rate Curve with dL');
%
